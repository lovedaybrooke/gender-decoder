...
def upgrade(migrate_engine):
    ...
    post_meta.tables['job_ad'].columns['feminine_coded_words'].create()
    post_meta.tables['job_ad'].columns['masculine_coded_words'].create()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    post_meta.tables['job_ad'].columns['feminine_coded_words'].drop()
    post_meta.tables['job_ad'].columns['masculine_coded_words'].drop()
